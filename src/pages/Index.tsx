      ...
      Ver Depoimentos dos Clientes
          ...
          <section id="depoimentos" className="mb-20 scroll-mt-32">
            ...
            <p className="text-center text-muted-foreground mb-12 text-lg">
              <span className="font-bold text-foreground">Centenas de violinista</span> já transformaram suas apresentações
            </p>
          ...
          <section className="mb-20">
            ...
            <div className="space-y-16">
              <VideoSection
                ...
                description="Clássico solo de violino! Temos também pop, rock, MPB, bossa e muito mais!"
              />
            ...
            <div className="text-center mt-16">
              <p className="text-2xl md:text-3xl font-bold text-foreground mb-8 font-display">
                E isso é só o começo! <span className="text-primary glow-text-blue">Mais de 500 temas</span> em diversos estilos
                esperando por você!
              </p>
            </div>
          </section>
            ...
            <div className="max-w-2xl mx-auto bg-gradient-to-br from-accent/20 via-primary/20 to-accent/10 backdrop-blur-sm border-4 border-accent/50 rounded-3xl p-8 md:p-12 glow-green shadow-2xl animate-scale-in">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-foreground">Mais de 500 vídeo partituras premium</p>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-accent flex-shrink-0" />
